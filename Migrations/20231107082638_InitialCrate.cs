        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsbCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    PrintLength = table.Column<int>(type: "int", nullable: true),
                    DeleteAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BorrowDetails_Accounts_AccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowDetails_AccountId",
                table: "BorrowDetails",
                column: "AccountId");
